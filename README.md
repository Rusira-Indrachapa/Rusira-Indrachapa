...
I am an IT Undergraduate passionate about building functional, visually polished desktop and web applications. Focused on mastering full-stack architecture, clean code practices, and exploring scalable cloud solutions.

- 🔭 **Education:** BIT Undergraduate at University of Moratuwa (External)
- 💻 **Core Focus:** Full Stack Development (Frontend + Backend architecture)
- ⚙️ **Currently Enhancing:** C#, Python, and Relational Databases
- ☁️ **Exploring:** Cloud computing & DevOps fundamentals
- ⚡ **Goal:** Building impactful, real-world project solutions
